    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_at",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Дата создания token-a"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "state",
                    models.CharField(max_length=15, verbose_name="Статус заказа"),
                ),
                (
                    "contact",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "model",
                    models.CharField(
                        blank=True, max_length=60, verbose_name="Not name"
                    ),
                ),
                ...
                (
                    "price_rrc",
                    models.PositiveIntegerField(verbose_name="Рекомендуемая цена"),
                ),
                (
                    "product",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "state",
                    models.BooleanField(
                        default=True, verbose_name="Статус получения заказ"
                    ),
                ),
                (
                    "user",
